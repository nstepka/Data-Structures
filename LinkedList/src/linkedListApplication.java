...
//		LL.PrintList();
		LL.ShowLinkedList();
		System.out.println("The average number is " + LL.avgDataValues());
		System.out.println("the largest key is " + LL.largestNode().item);
		System.out.println("Updated list with largest key removed");
		LL.ShowLinkedList();
